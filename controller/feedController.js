...
exports.updateFeed = (req, res) => {
  ...
  snsAppResponse(
    res, 
    feedService.updateFeed(feed_id, description), 
    "Feed updated", 
    `Feed with ID ${feed_id} not found for update`
  );
};
...
exports.deleteFeed = (req, res) => {
  ...
  snsAppResponse(
    ...
    "Feed deleted", 
    `Feed with ID ${feed_id} not found for deletion`
  );
};
...
exports.unlikeFeed = (req, res) => {
  ...
  snsAppResponse(
    ...
    "Feed unliked", 
    `Feed with ID ${feed_id} not found for unliking`
  );
};
...
exports.checkLikeStatus = (req, res) => {
  ...
  snsAppResponse(
    ...
    `Feed with ID ${feed_id} not found for like status check`
  );
};
...
exports.getLikeCount = (req, res) => {
  ...
  snsAppResponse(
    ...
    `Feed with ID ${feed_id} not found for like count`
  );
};
